...
import org.eclipse.tracecompass.tmf.analysis.xml.core.model.TmfXmlSyntheticEventBuilder;
...
public class TmfXmlReadWriteModelFactory implements ITmfXmlModelFactory {
     ...
     */
    @Override
    public TmfXmlPatternEventHandler createFilterEventHandler(Element node, IXmlStateSystemContainer container) {
     ...
     */
    @Override
    public TmfXmlSyntheticEventBuilder createSyntheticEventBuilder(Element node, IXmlStateSystemContainer container) {
        return new TmfXmlSyntheticEventBuilder(this, node, container);
    }
}
